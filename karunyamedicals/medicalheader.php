...
<head>
    ...
    <title>CovidCare4U -Karunya Medicals Homepage</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="medicalhome.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">CovidCare4U<br>Karunya Medicals</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="medicalhome.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="addmedicine.php">Add</a>
                       <a class="collapse-item" href="viewmedicines.php">View</a>
                    </div>
                </div>
            </li>
...
$lkey=$_COOKIE['lkey'];
$sql = "select * from tb_karunyamedicals where loginid='".$lkey."'"; //echo $sql;exit;
