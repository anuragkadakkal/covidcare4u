...
<script>
      ...
      else
      {
        ...
        return false
					...
					<form role="form" method="POST" action="ambulancereg1.php" name="myform" enctype="multipart/form-data">
						...
						<div class="form-group">
							<select class="form-control bfh-states" name="phckey" data-country="US" data-state="CA">
  ...
  <?php } ?>
						...
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6">
								<div class="form-group">
									<select class="form-control bfh-states country" name="brand">
                        ...
                        <label class="form-check-input" for="exampleRadios1" style="color: black;font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Driving Licence</label>&nbsp;<br>
							<input type="file" name="aadharfile1"  class="form-control input-sm" >
						</div>
