<?php
    ...
    $drid = $_COOKIE['lkey'];
    $sql="select * from tb_drbooking inner join tb_doctor on tb_doctor.loginid=tb_drbooking.dbdrid where dbdrid='".$drid."' and dbtime='".$_POST['rdate']."'order by dbid desc";
