<?php
$t=$_GET['t'];
header( "refresh:10;url=https://covidcare4u.herokuapp.com/foodbillpay.php?t=$t" );
$postdata = $_POST;
$msg = '';
...
<div class="main">
    ...
    <div>
    	<h3><font color="green">CovidCare4U - Community Kitchen Bill Payment Success</font></h3>
    </div>
