<?php
	...
	$sql3="insert into tb_vehiclepass(traveldate,returndate,fromplace,toplace,carregno,personcount,passkey,email,namelist,purpose,status,curdate,pkey,loginid) values 
	('".$tdate."','".$rdate."','".$from."','".$to."','".$vehno."','".$count."','".$passkey."','".$email."','".$namelist."','".$purpose."','".$status."','".$curdate."','".$pkey."','".$lkey."')";
