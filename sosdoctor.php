<?php 
	...
	<section id="about" style="background-color: #ecf5ff; box-shadow: 0px 0px 12px 0px #aeb8ba;">
		<div class="container ">
			...
			<header class="section-header">
				<h3>Doctor Appointment Booking</h3><br>
			</header>
  ...
  function otpUser() {
    ...
    <input type="number" id="inputPhone" class="form-control" placeholder="Phone Number" onkeyup="phoneUser()">
    ...
    <input type="password" id="inputOtp" class="form-control" placeholder="OTP" onclick="otpUser()">
