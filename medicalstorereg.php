	...
	<section id="about" style="background-color: #ecf5ff; box-shadow: 0px 0px 12px 0px #aeb8ba;">
		<div class="container ">
			...
			<header class="section-header">
				<h3>Karunya Medical Store Registration</h3><br>
			</header>
<script>
	function firstName() {
		...
		if(!/^[A-Za-z ]{5,36}$/.test(fname))
	     {
	       f1.textContent = "**Invalid Medical Store Name";
...
function checkAll() {
		...
		if(firstName()&&lastName()&&emailUser()&&addrUser()&&phoneUser()&&distUser()&&distPinz()&&passUser()&&conpassUser()&&fileCheck())
	     {
	       return true;
	     }
	     else
	     {
	     	return false;
					...
					<form role="form" method="POST" action="medstorereg.php" name="myform" enctype="multipart/form-data">
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6">
								<div class="form-group">
									<input type="text" name="fname" class="form-control input-sm" placeholder="Medical Store Name" id="fname" onkeyup="firstName()">
						...
						<div class="form-group">
                        <label class="form-check-input" for="exampleRadios1" style="color: black;font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Registration Certificate [.pdf]</label>&nbsp;<br>
