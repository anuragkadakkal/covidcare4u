...
<?php 
$key=$_GET['t'];
 $sql = "select * from tb_policestation where policekey='".$key."'";
  $result = mysqli_query($conn,$sql); ?>

                          <form role="form" action="updatepolicereg.php" method="post" enctype="multipart/form-data" name="myform">
 ...
 <?php while ($row=mysqli_fetch_array($result))
                      {   ?>
                                ...
                                <span style="color: red;font-size: 14px" id="f4"></span>
              			    			...
              			    			<div class="form-group">
              			    				<input type="email" name="email"  class="form-control input-sm" placeholder="Email Address" value="<?php echo $row['email']; ?>" id="email" onkeyup="emailUser()">
