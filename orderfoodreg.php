<?php
  ...
  $kitkey= $_POST['kitkey'];
    ...
    $sql="insert into tb_food (filekey,fname,address,items,phno,qstatus,district,pincode,status,curdate,kitkey,loginid) values ('".$filekey."','".$firstname."','".$address."','".$items."','".$phno."','".$qstatus."','".$dist."','".$pin."','".$status."','".$curdate."','".$kitkey."','".$loginid."')";
