<?php
	...
	$sql="update tb_food set status='4' where filekey='".$key."'";
	...
	if($result)
	{
		...
		echo "<SCRIPT type='text/javascript'>alert('Payment updated in your community kitchen.'); window.location.replace(\"orderfoodstatus.php\"); </SCRIPT>";
	}
