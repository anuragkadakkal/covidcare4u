...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="drhome.php"><i class="fas fa-bars text-success"><span class=" font-weight-light text-success">&nbsp;&nbsp;<?php echo $fullname; ?></span>
          </i></a>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="drhome.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
				<a  href="drhome.php" class="nav-link " >
